        ...
        public Response ImportPartDetails()
        {
            ...
            try
            {
                ...
                using (ExcelPackage package = new ExcelPackage(stockEntryUploadedFile.InputStream))
                {
                    ...
                    var prevUniqueCode = Utilities.PartDetails_UniqueCodeAutoGenerated();

                    for (int rowIterator = 2; rowIterator <= noOfRow; rowIterator++)
                    {
                        if (rowIterator > 2)
                        {
                            prevUniqueCode = prevUniqueCode.Substring(0, 3) + (Convert.ToInt32(prevUniqueCode.Substring(7, prevUniqueCode.Length - 7)) + 1).ToString("D7");
                        }

                        PartDetailsImportRequestModel record = new PartDetailsImportRequestModel();
                        record.UniqueCode = prevUniqueCode;
                ...
                if (objImportPartDetails_Result.Count > 0)
                {
                    ...
                    if (dtInvalidRecords.Rows.Count > 0)
                    {
                        ...
                        WorkSheet1.Cells[1, 1].Value = "UniqueCode";
                        WorkSheet1.Cells[1, 2].Value = "PartNumber";
                        WorkSheet1.Cells[1, 3].Value = "PartName";
                        WorkSheet1.Cells[1, 4].Value = "PartDescription";
                        WorkSheet1.Cells[1, 5].Value = "CTSerialNo";
                        WorkSheet1.Cells[1, 6].Value = "PartStatus";
                        WorkSheet1.Cells[1, 7].Value = "SalePrice";
                        WorkSheet1.Cells[1, 8].Value = "CompanyName";
                        WorkSheet1.Cells[1, 9].Value = "BranchName";
                        WorkSheet1.Cells[1, 10].Value = "ReceiveFrom";
                        WorkSheet1.Cells[1, 11].Value = "ReceiveDate";
                        WorkSheet1.Cells[1, 12].Value = "DocketNo";
                        WorkSheet1.Cells[1, 13].Value = "StockPartStatus";
                        WorkSheet1.Cells[1, 14].Value = "PurchasePrice";
                        WorkSheet1.Cells[1, 15].Value = "VendorName";
                        WorkSheet1.Cells[1, 16].Value = "Quantity";
                        WorkSheet1.Cells[1, 17].Value = "HSNCode";
                        WorkSheet1.Cells[1, 18].Value = "IsActive";
                        WorkSheet1.Cells[1, 19].Value = "ValidationMessage";

                        recordIndex = 2;

                        foreach (DataRow dataRow in dtInvalidRecords.Rows)
                        {
                            WorkSheet1.Cells[recordIndex, 1].Value = dataRow["UniqueCode"];
                            WorkSheet1.Cells[recordIndex, 2].Value = dataRow["PartNumber"];
                            WorkSheet1.Cells[recordIndex, 3].Value = dataRow["PartName"];
                            WorkSheet1.Cells[recordIndex, 4].Value = dataRow["PartDescription"];
                            WorkSheet1.Cells[recordIndex, 5].Value = dataRow["CTSerialNo"];
                            WorkSheet1.Cells[recordIndex, 6].Value = dataRow["PartStatus"];
                            WorkSheet1.Cells[recordIndex, 7].Value = dataRow["SalePrice"];
                            WorkSheet1.Cells[recordIndex, 8].Value = dataRow["CompanyName"];
                            WorkSheet1.Cells[recordIndex, 9].Value = dataRow["BranchName"];
                            WorkSheet1.Cells[recordIndex, 10].Value = dataRow["ReceiveFrom"];
                            WorkSheet1.Cells[recordIndex, 11].Value = dataRow["ReceiveDate"];
                            WorkSheet1.Cells[recordIndex, 12].Value = dataRow["DocketNo"];
                            WorkSheet1.Cells[recordIndex, 13].Value = dataRow["StockPartStatus"];
                            WorkSheet1.Cells[recordIndex, 14].Value = dataRow["PurchasePrice"];
                            WorkSheet1.Cells[recordIndex, 15].Value = dataRow["VendorName"];
                            WorkSheet1.Cells[recordIndex, 16].Value = dataRow["Quantity"];
                            WorkSheet1.Cells[recordIndex, 17].Value = dataRow["HSNCode"];
                            WorkSheet1.Cells[recordIndex, 18].Value = dataRow["IsActive"];
                            WorkSheet1.Cells[recordIndex, 19].Value = dataRow["ValidationMessage"];
