            ...
            try
            {
                ...
                else
                {
                    ...
                    if (dtWOEReport.Rows.Count > 0)
                    {
                        ...
                        WorkSheet1.Cells[1, 6].Value = "Customer Name";
                        WorkSheet1.Cells[1, 7].Value = "Customer Mobile No";
                        WorkSheet1.Cells[1, 8].Value = "Customer Email id";
                        WorkSheet1.Cells[1, 9].Value = "Customer GST Number";
                        WorkSheet1.Cells[1, 10].Value = "Product Make";
                        WorkSheet1.Cells[1, 11].Value = "Product Model";
                        WorkSheet1.Cells[1, 12].Value = "Product Serial Number";
                        WorkSheet1.Cells[1, 13].Value = "Product Number";
                        WorkSheet1.Cells[1, 14].Value = "Product Description";
                        WorkSheet1.Cells[1, 15].Value = "Branch GST Number";
                        WorkSheet1.Cells[1, 16].Value = "Branch Name";
                        WorkSheet1.Cells[1, 17].Value = "Service Product Type";
                        WorkSheet1.Cells[1, 18].Value = "HSN Code";
                        WorkSheet1.Cells[1, 19].Value = "Zone";
                        WorkSheet1.Cells[1, 20].Value = "Price";
                        WorkSheet1.Cells[1, 21].Value = "Description";
                        WorkSheet1.Cells[1, 22].Value = "Discount %";
                        WorkSheet1.Cells[1, 23].Value = "After Dis. Price";
                        WorkSheet1.Cells[1, 24].Value = "CGST Rate %";
                        WorkSheet1.Cells[1, 25].Value = "CGST Value";
                        WorkSheet1.Cells[1, 26].Value = "SGST Rate %";
                        WorkSheet1.Cells[1, 27].Value = "SGST Value";
                        WorkSheet1.Cells[1, 28].Value = "IGST Rate %";
                        WorkSheet1.Cells[1, 29].Value = "IGST Value";
                        WorkSheet1.Cells[1, 30].Value = "Part Number";
                        WorkSheet1.Cells[1, 31].Value = "STN Number";
                        WorkSheet1.Cells[1, 32].Value = "Part Discription";
                        WorkSheet1.Cells[1, 33].Value = "HSN Code";
                        WorkSheet1.Cells[1, 34].Value = "Sale Price";
                        WorkSheet1.Cells[1, 35].Value = "Discount %";
                        WorkSheet1.Cells[1, 36].Value = "After Dis. Price";
                        WorkSheet1.Cells[1, 37].Value = "CGST Rate %";
                        WorkSheet1.Cells[1, 38].Value = "CGST Value";
                        WorkSheet1.Cells[1, 39].Value = "SGST Rate %";
                        WorkSheet1.Cells[1, 40].Value = "SGST Value";
                        WorkSheet1.Cells[1, 41].Value = "IGST Rate %";
                        WorkSheet1.Cells[1, 42].Value = "IGST Value";
                        WorkSheet1.Cells[1, 43].Value = "Amount Before Tax";
                        WorkSheet1.Cells[1, 44].Value = "Total Discount";
                        WorkSheet1.Cells[1, 45].Value = "Total CGST Value";
                        WorkSheet1.Cells[1, 46].Value = "Total SGST Value";
                        WorkSheet1.Cells[1, 47].Value = "Total IGST Value";
                        WorkSheet1.Cells[1, 48].Value = "Gross Amount Including Taxes";
                        WorkSheet1.Cells[1, 49].Value = "Advanced Received";
                        WorkSheet1.Cells[1, 50].Value = "Total Received";
                        WorkSheet1.Cells[1, 51].Value = "OutStanding Amount";
                        WorkSheet1.Cells[1, 52].Value = "Payment Status";
                        ...
                        foreach (DataRow dataRow in dtWOEReport.Rows)
                        {
                            ...
                            WorkSheet1.Cells[recordIndex, 6].Value = dataRow["CustomerName"];
                            WorkSheet1.Cells[recordIndex, 7].Value = dataRow["CustomerMobileNo"];
                            WorkSheet1.Cells[recordIndex, 8].Value = dataRow["CustomerEmailId"];
                            WorkSheet1.Cells[recordIndex, 9].Value = dataRow["CustomerGSTNumber"];
                            WorkSheet1.Cells[recordIndex, 10].Value = dataRow["ProductMake"];
                            WorkSheet1.Cells[recordIndex, 11].Value = dataRow["ProductModel"];
                            WorkSheet1.Cells[recordIndex, 12].Value = dataRow["ProductSerialNumber"];
                            WorkSheet1.Cells[recordIndex, 13].Value = dataRow["ProductNumber"];
                            WorkSheet1.Cells[recordIndex, 14].Value = dataRow["ProductDescription"];
                            WorkSheet1.Cells[recordIndex, 15].Value = dataRow["BranchGSTNumber"];
                            WorkSheet1.Cells[recordIndex, 16].Value = dataRow["BranchName"];
                            WorkSheet1.Cells[recordIndex, 17].Value = dataRow["ServiceProductType"];
                            WorkSheet1.Cells[recordIndex, 18].Value = dataRow["ServiceHSNCode"];
                            WorkSheet1.Cells[recordIndex, 19].Value = dataRow["TravelZone"];
                            WorkSheet1.Cells[recordIndex, 20].Value = dataRow["Price"];
                            WorkSheet1.Cells[recordIndex, 21].Value = dataRow["Description"];
                            WorkSheet1.Cells[recordIndex, 22].Value = dataRow["DiscPerct"];
                            WorkSheet1.Cells[recordIndex, 23].Value = dataRow["PriceAfterDisc"];
                            WorkSheet1.Cells[recordIndex, 24].Value = dataRow["CGSTPerct"];
                            WorkSheet1.Cells[recordIndex, 25].Value = dataRow["CGSTValue"];
                            WorkSheet1.Cells[recordIndex, 26].Value = dataRow["SGSTPerct"];
                            WorkSheet1.Cells[recordIndex, 27].Value = dataRow["SGSTValue"];
                            WorkSheet1.Cells[recordIndex, 28].Value = dataRow["IGSTPerct"];
                            WorkSheet1.Cells[recordIndex, 29].Value = dataRow["IGSTValue"];
                            WorkSheet1.Cells[recordIndex, 30].Value = dataRow["PartNumber"];
                            WorkSheet1.Cells[recordIndex, 31].Value = dataRow["STNNumber"];
                            WorkSheet1.Cells[recordIndex, 32].Value = dataRow["PartDescription"];
                            WorkSheet1.Cells[recordIndex, 33].Value = dataRow["PartHSNCode"];
                            WorkSheet1.Cells[recordIndex, 34].Value = dataRow["SalePrice"];
                            WorkSheet1.Cells[recordIndex, 35].Value = dataRow["PartDiscPerct"];
                            WorkSheet1.Cells[recordIndex, 36].Value = dataRow["PartPriceAfterDisc"];
                            WorkSheet1.Cells[recordIndex, 37].Value = dataRow["PartCGSTPerct"];
                            WorkSheet1.Cells[recordIndex, 38].Value = dataRow["PartCGSTValue"];
                            WorkSheet1.Cells[recordIndex, 39].Value = dataRow["PartSGSTPerct"];
                            WorkSheet1.Cells[recordIndex, 40].Value = dataRow["PartSGSTValue"];
                            WorkSheet1.Cells[recordIndex, 41].Value = dataRow["PartIGSTPerct"];
                            WorkSheet1.Cells[recordIndex, 42].Value = dataRow["PartIGSTValue"];
                            WorkSheet1.Cells[recordIndex, 43].Value = dataRow["AmountBeforeTax"];
                            WorkSheet1.Cells[recordIndex, 44].Value = dataRow["TotalDiscAmt"];
                            WorkSheet1.Cells[recordIndex, 45].Value = dataRow["TotalCGSTValue"];
                            WorkSheet1.Cells[recordIndex, 46].Value = dataRow["TotalSGSTValue"];
                            WorkSheet1.Cells[recordIndex, 47].Value = dataRow["TotalIGSTValue"];
                            WorkSheet1.Cells[recordIndex, 48].Value = dataRow["GrossAmountIncludeTax"];
                            WorkSheet1.Cells[recordIndex, 49].Value = dataRow["AdvanceReceived"];
                            WorkSheet1.Cells[recordIndex, 50].Value = dataRow["AmountPaidAfter"];
                            WorkSheet1.Cells[recordIndex, 51].Value = dataRow["OutstandingAmount"];
                            WorkSheet1.Cells[recordIndex, 52].Value = dataRow["PaymentStatus"];
                        ...
                        WorkSheet1.Column(42).AutoFit();
                        WorkSheet1.Column(43).AutoFit();
                        WorkSheet1.Column(44).AutoFit();
                        WorkSheet1.Column(45).AutoFit();
                        WorkSheet1.Column(46).AutoFit();
                        WorkSheet1.Column(47).AutoFit();
                        WorkSheet1.Column(48).AutoFit();
                        WorkSheet1.Column(49).AutoFit();
                        WorkSheet1.Column(50).AutoFit();
                        WorkSheet1.Column(51).AutoFit();
                        WorkSheet1.Column(52).AutoFit();
